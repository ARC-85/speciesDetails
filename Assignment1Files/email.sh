...
echo ""
echo "-----------------------------Email-----------------------------------"
PS3=$'\nTo email a recorder or recorders, please choose one of the above options (enter the number): '
echo $'\n'
options=("Search entire list of recorder emails alphabetically" "Search individual recorder emails" "Search for recorders by particular species name" "Email all recorders" "Main Menu")
...
do 
		...
		"Email all recorders")
                        ...
                        echo $'\nList of all emails: \n'
			cat -n speciesDetailsAlpha.txt
                        echo $'\nWould you like to email all of the recorders (y/n)?'
                        read decision
                        case $decision in 
                                [yY] )
                                        echo ""
